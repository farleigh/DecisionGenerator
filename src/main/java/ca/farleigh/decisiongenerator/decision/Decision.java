...
/**
 * Represents a single decision point. Ultimately, decisions are composed of
 * choices that will have to be made by the user -- but that DecisionGenerator
...
public final class Decision implements ExpectedValue {
     ...
     * @param name
     *            identifier for the decision (a string that describes the
     *            decision)
     * @param choices
     *            All choices available for the decision
     */
     ...
     * 
     * @param choices
     *            The set of all choices that will be used for this decision
     */
